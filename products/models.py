...
class Product(models.Model):
    ...
    track_list1 = models.TextField(null=True, blank=True)
    track_list2 = models.TextField(null=True, blank=True)
    track_list3 = models.TextField(null=True, blank=True)
    track_list4 = models.TextField(null=True, blank=True)
